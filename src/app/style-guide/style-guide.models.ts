export const STYLE_GUIDE_MENU = [
  {
    ...
    icon: 'text_fields',
    link: '/typography',
    desc: `Pretendard Font를 기반으로 한 Typography`,
  },
  {
    name: 'Form',
    icon: 'edit_note',
...
export const BREADCRUMB_SAMPLE = [
  {
    name: 'Menu',
    menu: [
      {
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'Knob', link: '/form/knob', desc: 'Knob 설명 <span></span>' },
          {
            name: 'Select',
            link: '/form/select',
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'Tree', link: '/data/tree', desc: 'Tree 설명 <span></span>' },
        ],
      },
      {
        name: 'Panel',
      ...
      },
      {
        ...
        children: [
          ...
          { name: 'Menu', link: '/menu/menu', desc: 'Menu 설명 <span></span>' },
          {
            name: 'Steps',
            link: '/menu/steps',
            desc: 'Steps 설명 <span></span>',
  ...
  },
  {
    ...
    menu: [
      ...
      { name: 'Menu', link: '/menu/menu', desc: 'Menu 설명 <span></span>' },
      { name: 'Steps', link: '/menu/steps', desc: 'Steps 설명 <span></span>' },
      {
        name: 'TabMenu',
        link: '/menu/tabMenu',
        desc: 'TabMenu 설명 <span></span>',
