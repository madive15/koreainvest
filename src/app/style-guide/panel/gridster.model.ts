...
export const originDashboard: Array<DASHBOARD_ITEM_TYPE> = [
  ...
  },
  {
    ...
    minItemRows: 4,
    config: {
      title: 'main.recommendKeyword',
      chart: 'list',
      widgetType: 'recommendKeyword',
    },
    disabled: true,
  },
  {
    ...
    minItemRows: 4,
    config: {
      title: 'main.recommendDataset',
      chart: 'list',
      widgetType: 'recommendDataset',
    },
    disabled: true,
  },
  {
    ...
    minItemRows: 4,
    config: {
      title: 'main.sourceSystem',
      chart: 'bar',
      widgetType: 'sourceSystem',
    },
    disabled: true,
  },
  {
    ...
    minItemCols: 5,
    config: {
      title: 'main.sourceSystemType',
      chart: 'barH',
      widgetType: 'sourceSystemType',
    },
    disabled: true,
  },
  {
    ...
    minItemRows: 4,
    config: {
      title: 'main.topDataset',
      chart: 'pie',
      widgetType: 'topDataset',
    },
    disabled: true,
  },
  // {
